...
Please read the full documentation and licensing from the original author [site][3], here it's just a copy to keep in sync my custom forked [version][1] with [original version][4].
